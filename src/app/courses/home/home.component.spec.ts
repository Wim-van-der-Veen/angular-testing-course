...
describe('HomeComponent', () => {
    ...
    it("should display only beginner courses", () => {
        ...
        expect(tabs).toBeTruthy('Could not find tabs');
    ...
    it("should display advanced courses when tab clicked - timeout", (done: DoneFn) => {
        ...
        expect(advancedTab).toBeTruthy('Could not find advanced tab');
        click(advancedTab);
        fixture.detectChanges();

        setTimeout(() => {
            const cardTitles = el.queryAll(By.css('.mat-tab-body-active .mat-card-title'));
            expect(cardTitles).toBeTruthy('Could not find cards');
